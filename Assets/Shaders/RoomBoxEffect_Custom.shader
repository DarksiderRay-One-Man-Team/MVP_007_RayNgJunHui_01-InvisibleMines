...
Shader "MixedReality/SceneMeshCustom" {
    Properties
    {
        _SceneMeshCustomColor ("Tint", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i, fixed facing : VFACE) : SV_Target
            {
                ...
                fixed4 edgeEffect = _SceneMeshCustomColor * stroke + _SceneMeshCustomColor * pow(glow,4);
                ...
                fixed4 floorEffect = edgeEffect + _SceneMeshCustomColor * groundGrid + _SceneMeshCustomColor * (groundGlow * 0.25 + 0.2);
